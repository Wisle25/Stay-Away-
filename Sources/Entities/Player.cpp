    ...
    Entity(Args)
{
    ...
    M_Animations[IDLE_X] = new Animation(Sprite, "../Resources/Sprites/MC/Idle_left.png", 14.f, 64);
    M_Animations[IDLE_DOWN] = new Animation(Sprite, "../Resources/Sprites/MC/mc_frontidle.png", 28.f, 64);
