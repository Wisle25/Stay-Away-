...
const String Modal::GetInput() const
{
...
void Modal::AddDropdown(std::vector<String>* Lists, sf::Font& Font, unsh CharSize, BColorArgs Colors, std::vector<std::function<void(sf::Event*)>>* EventQueue)
{
...
void Modal::SetTextContent(String& i_Text)
{
