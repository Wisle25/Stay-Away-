...
public:
    ...
    /////////////////////////////
    ScrollMode(sf::Vector2f Size, sf::Color Color, std::vector<Card*>* I_Cards, sf::VideoMode& ScreenSize, std::vector<std::function<void(sf::Event*)>>* EventQueue);
    virtual ~ScrollMode();
    ...
    // Lifecycle
    /////////////////////////////
    void OnUpdate(const sf::Vector2s& MousePosition, bool I_Active = true);
